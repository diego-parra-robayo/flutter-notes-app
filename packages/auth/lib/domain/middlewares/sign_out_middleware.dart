...
class SignOutMiddleware extends CustomMiddleware<SignOutMiddleware> {
  final AuthRepository repository;

  SignOutMiddleware({required this.repository});

  @override
  Future execute(Store<AppState> store, SignOutMiddleware action) async {
